...
export type LVal = Identifier | MemberExpression | ArrayPattern | ObjectPattern | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression;
...
export type Immutable = StringLiteral | NumericLiteral | NullLiteral | BooleanLiteral | BigIntLiteral | JSXAttribute | JSXClosingElement | JSXElement | JSXExpressionContainer | JSXSpreadChild | JSXOpeningElement | JSXText | JSXFragment | JSXOpeningFragment | JSXClosingFragment;
...
export type Property = ObjectProperty | ClassProperty | ClassPrivateProperty | ClassAccessorProperty;
...
export function assignmentExpression(operator: "=" | "+=" | "-=" | "/=" | "%=" | "*=" | "**=" | "&=" | "|=" | ">>=" | ">>>=" | "<<=" | "^=" | "||=" | "&&=" | "??=", left: Identifier | MemberExpression | OptionalMemberExpression | ArrayPattern | ObjectPattern | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression, right: Expression): AssignmentExpression;
...
export function callExpression(callee: Expression | Super | Import | V8IntrinsicIdentifier, _arguments: (Expression | SpreadElement | ArgumentPlaceholder)[]): CallExpression;
...
export function forInStatement(left: VariableDeclaration | Identifier | MemberExpression | ArrayPattern | ObjectPattern | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression, right: Expression, body: Statement): ForInStatement;
...
export function memberExpression(object: Expression | Super, property: Expression | Identifier | PrivateName, computed?: boolean): MemberExpression;
export function newExpression(callee: Expression | V8IntrinsicIdentifier, _arguments: (Expression | SpreadElement | ArgumentPlaceholder)[]): NewExpression;
...
export function objectMethod(kind: "method" | "get" | "set", key: Expression | Identifier | StringLiteral | NumericLiteral | BigIntLiteral, params: FunctionParameter[], body: BlockStatement, computed?: boolean, generator?: boolean, async?: boolean): ObjectMethod;
export function objectProperty(key: Expression | Identifier | StringLiteral | NumericLiteral | BigIntLiteral | PrivateName, value: Expression | PatternLike, computed?: boolean, shorthand?: boolean): ObjectProperty;
export function restElement(argument: Identifier | ArrayPattern | ObjectPattern | MemberExpression | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression): RestElement;
...
export function updateExpression(operator: "++" | "--", argument: Identifier | MemberExpression, prefix?: boolean): UpdateExpression;
...
export function variableDeclarator(id: Identifier | ArrayPattern | ObjectPattern | VoidPattern, init?: Expression | null): VariableDeclarator;
...
export function exportDefaultDeclaration(declaration: FunctionDeclaration | ClassDeclaration | Expression | TSDeclareFunction | TSInterfaceDeclaration | EnumDeclaration): ExportDefaultDeclaration;
...
export function exportSpecifier(local: Identifier | StringLiteral, exported: Identifier | StringLiteral): ExportSpecifier;
export function forOfStatement(left: VariableDeclaration | Identifier | MemberExpression | ArrayPattern | ObjectPattern | TSAsExpression | TSSatisfiesExpression | TSTypeAssertion | TSNonNullExpression, right: Expression, body: Statement, _await?: boolean): ForOfStatement;
...
export function classMethod(kind: "get" | "set" | "method" | "constructor" | undefined, key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression | PrivateName, params: (FunctionParameter | TSParameterProperty)[], body: BlockStatement, computed?: boolean, _static?: boolean, generator?: boolean, async?: boolean): ClassMethod;
...
export function templateElement(value: { raw: string, cooked?: string | null }, tail?: boolean): TemplateElement;
...
export function exportNamespaceSpecifier(exported: Identifier | StringLiteral): ExportNamespaceSpecifier;
export function optionalMemberExpression(object: Expression, property: Expression | PrivateName, computed: boolean | undefined, optional: boolean): OptionalMemberExpression;
...
export function classProperty(key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression | PrivateName, value?: Expression | null, typeAnnotation?: TypeAnnotation | TSTypeAnnotation | null, decorators?: Decorator[] | null, computed?: boolean, _static?: boolean): ClassProperty;
...
export function declaredPredicate(value: Expression): DeclaredPredicate;
...
export function bigIntLiteralTypeAnnotation(value: bigint): BigIntLiteralTypeAnnotation;
...
export function objectTypeProperty(key: Identifier | StringLiteral | NumericLiteral, value: FlowType, variance?: Variance | null): ObjectTypeProperty;
...
export function typeofTypeAnnotation(argument: FlowType | Identifier): TypeofTypeAnnotation;
export function typeAlias(id: Identifier, typeParameters: TypeParameterDeclaration | null | undefined, right: FlowType): TypeAlias;
export function typeAnnotation(typeAnnotation: FlowType | Identifier): TypeAnnotation;
export function typeCastExpression(expression: Expression, typeAnnotation: TypeAnnotation): TypeCastExpression;
export function typeParameter(name: string, bound?: TypeAnnotation | null, _default?: FlowType | null, variance?: Variance | null): TypeParameter;
...
export function enumBooleanMember(id: Identifier, init: BooleanLiteral): EnumBooleanMember;
...
export function jsxElement(openingElement: JSXOpeningElement, closingElement: JSXClosingElement | null | undefined, children: (JSXText | JSXExpressionContainer | JSXSpreadChild | JSXElement | JSXFragment)[]): JSXElement;
...
export function bindExpression(object: null | Expression, callee: Expression): BindExpression;
export function classAccessorProperty(key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression | PrivateName, value?: Expression | null, typeAnnotation?: TypeAnnotation | TSTypeAnnotation | null, decorators?: Decorator[] | null, computed?: boolean, _static?: boolean): ClassAccessorProperty;
...
export function tsDeclareFunction(id: Identifier | null | undefined, typeParameters: TSTypeParameterDeclaration | null | undefined, params: FunctionParameter[], returnType?: TSTypeAnnotation | null): TSDeclareFunction;
export function tsDeclareMethod(key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression | PrivateName, typeParameters: TSTypeParameterDeclaration | null | undefined, params: (FunctionParameter | TSParameterProperty)[], returnType?: TSTypeAnnotation | null): TSDeclareMethod;
export function tsQualifiedName(left: TSEntityName, right: Identifier): TSQualifiedName;
export function tsCallSignatureDeclaration(typeParameters: TSTypeParameterDeclaration | null | undefined, params: (ArrayPattern | Identifier | ObjectPattern | RestElement)[], returnType?: TSTypeAnnotation | null): TSCallSignatureDeclaration;
export function tsConstructSignatureDeclaration(typeParameters: TSTypeParameterDeclaration | null | undefined, params: (ArrayPattern | Identifier | ObjectPattern | RestElement)[], returnType?: TSTypeAnnotation | null): TSConstructSignatureDeclaration;
export function tsPropertySignature(key: Expression, typeAnnotation?: TSTypeAnnotation | null): TSPropertySignature;
export function tsMethodSignature(key: Expression, typeParameters: TSTypeParameterDeclaration | null | undefined, params: (ArrayPattern | Identifier | ObjectPattern | RestElement)[], returnType?: TSTypeAnnotation | null): TSMethodSignature;
...
export function tsFunctionType(typeParameters: TSTypeParameterDeclaration | null | undefined, params: (ArrayPattern | Identifier | ObjectPattern | RestElement)[], returnType?: TSTypeAnnotation | null): TSFunctionType;
export function tsConstructorType(typeParameters: TSTypeParameterDeclaration | null | undefined, params: (ArrayPattern | Identifier | ObjectPattern | RestElement)[], returnType?: TSTypeAnnotation | null): TSConstructorType;
export function tsTypeReference(typeName: TSEntityName, typeArguments?: TSTypeParameterInstantiation | null): TSTypeReference;
...
export function tsTypeQuery(exprName: TSEntityName | TSImportType, typeArguments?: TSTypeParameterInstantiation | null): TSTypeQuery;
...
export function tsTypeOperator(typeAnnotation: TSType, operator: "keyof" | "readonly" | "unique"): TSTypeOperator;
export function tsIndexedAccessType(objectType: TSType, indexType: TSType): TSIndexedAccessType;
export function tsMappedType(key: Identifier, constraint: TSType, nameType?: TSType | null, typeAnnotation?: TSType | null): TSMappedType;
...
export function tsClassImplements(expression: Expression, typeArguments?: TSTypeParameterInstantiation | null): TSClassImplements;
export function tsInterfaceHeritage(expression: Expression, typeArguments?: TSTypeParameterInstantiation | null): TSInterfaceHeritage;
export function tsInterfaceDeclaration(id: Identifier, typeParameters: TSTypeParameterDeclaration | null | undefined, _extends: TSInterfaceHeritage[] | null | undefined, body: TSInterfaceBody): TSInterfaceDeclaration;
...
export function tsInstantiationExpression(expression: Expression, typeArguments?: TSTypeParameterInstantiation | null): TSInstantiationExpression;
...
export function tsEnumDeclaration(id: Identifier, body: TSEnumBody): TSEnumDeclaration;
export function tsEnumMember(id: Identifier | StringLiteral, initializer?: Expression | null): TSEnumMember;
export function tsModuleDeclaration(id: TSEntityName | StringLiteral, body: TSModuleBlock): TSModuleDeclaration;
export function tsModuleBlock(body: Statement[]): TSModuleBlock;
export function tsImportType(source: StringLiteral, qualifier?: TSEntityName | null, typeArguments?: TSTypeParameterInstantiation | null): TSImportType;
...
export function isBigIntLiteralTypeAnnotation(node: object | null | undefined, opts?: object | null): node is BigIntLiteralTypeAnnotation;
export function assertBigIntLiteralTypeAnnotation(node: object | null | undefined, opts?: object | null): void;
...
export function isTSClassImplements(node: object | null | undefined, opts?: object | null): node is TSClassImplements;
export function assertTSClassImplements(node: object | null | undefined, opts?: object | null): void;
...
export function isTSInterfaceHeritage(node: object | null | undefined, opts?: object | null): node is TSInterfaceHeritage;
export function assertTSInterfaceHeritage(node: object | null | undefined, opts?: object | null): void;
