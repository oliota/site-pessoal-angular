...
declare class BabelNodeAssignmentExpression extends BabelNode {
  ...
  operator: "=" | "+=" | "-=" | "/=" | "%=" | "*=" | "**=" | "&=" | "|=" | ">>=" | ">>>=" | "<<=" | "^=" | "||=" | "&&=" | "??=";
  left: BabelNodeIdentifier | BabelNodeMemberExpression | BabelNodeOptionalMemberExpression | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression;
...
declare class BabelNodeCallExpression extends BabelNode {
  type: "CallExpression";
  callee: BabelNodeExpression | BabelNodeSuper | BabelNodeImport | BabelNodeV8IntrinsicIdentifier;
...
declare class BabelNodeForInStatement extends BabelNode {
  type: "ForInStatement";
  left: BabelNodeVariableDeclaration | BabelNodeIdentifier | BabelNodeMemberExpression | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression;
  right: BabelNodeExpression;
  body: BabelNodeStatement;
}
...
declare class BabelNodeFunctionDeclaration extends BabelNode {
  ...
  async?: boolean;
  declare?: boolean;
  predicate?: BabelNodeFlowPredicate;
...
declare class BabelNodeObjectProperty extends BabelNode {
  type: "ObjectProperty";
  key: BabelNodeExpression | BabelNodeIdentifier | BabelNodeStringLiteral | BabelNodeNumericLiteral | BabelNodeBigIntLiteral | BabelNodePrivateName;
...
declare class BabelNodeRestElement extends BabelNode {
  type: "RestElement";
  argument: BabelNodeIdentifier | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeMemberExpression | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression;
  decorators?: BabelNodeDecorator[];
  optional?: boolean;
  typeAnnotation?: BabelNodeTypeAnnotation | BabelNodeTSTypeAnnotation;
}
...
declare class BabelNodeUpdateExpression extends BabelNode {
  ...
  operator: "++" | "--";
  argument: BabelNodeIdentifier | BabelNodeMemberExpression;
  prefix?: boolean;
}
...
declare class BabelNodeVariableDeclarator extends BabelNode {
  ...
  id: BabelNodeIdentifier | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeVoidPattern;
...
declare class BabelNodeClassExpression extends BabelNode {
  ...
  superTypeArguments?: BabelNodeTypeParameterInstantiation | BabelNodeTSTypeParameterInstantiation;
  typeParameters?: BabelNodeTypeParameterDeclaration | BabelNodeTSTypeParameterDeclaration;
}
...
declare class BabelNodeExportDefaultDeclaration extends BabelNode {
  ...
  declaration: BabelNodeFunctionDeclaration | BabelNodeClassDeclaration | BabelNodeExpression | BabelNodeTSDeclareFunction | BabelNodeTSInterfaceDeclaration | BabelNodeEnumDeclaration;
  exportKind?: "value";
}

declare class BabelNodeExportNamedDeclaration extends BabelNode {
  type: "ExportNamedDeclaration";
  declaration?: BabelNodeVariableDeclaration | BabelNodeFunctionDeclaration | BabelNodeClassDeclaration | BabelNodeTSDeclareFunction | BabelNodeTSEnumDeclaration | BabelNodeTSImportEqualsDeclaration | BabelNodeTSInterfaceDeclaration | BabelNodeTSModuleDeclaration | BabelNodeTSTypeAliasDeclaration | BabelNodeEnumDeclaration | BabelNodeInterfaceDeclaration | BabelNodeOpaqueType | BabelNodeTypeAlias;
...
declare class BabelNodeExportSpecifier extends BabelNode {
  ...
  local: BabelNodeIdentifier | BabelNodeStringLiteral;
...
declare class BabelNodeOptionalMemberExpression extends BabelNode {
  ...
  object: BabelNodeExpression;
  property: BabelNodeExpression | BabelNodePrivateName;
  computed?: boolean;
  optional: boolean;
}
...
declare class BabelNodeBigIntLiteralTypeAnnotation extends BabelNode {
...
declare class BabelNodeObjectTypeProperty extends BabelNode {
  ...
  key: BabelNodeIdentifier | BabelNodeStringLiteral | BabelNodeNumericLiteral;
  value: BabelNodeFlowType;
  variance?: BabelNodeVariance;
  kind?: "init" | "get" | "set";
  method?: boolean;
...
declare class BabelNodeTypeofTypeAnnotation extends BabelNode {
  ...
  argument: BabelNodeFlowType | BabelNodeIdentifier;
}
...
declare class BabelNodeTypeAnnotation extends BabelNode {
  type: "TypeAnnotation";
  typeAnnotation: BabelNodeFlowType | BabelNodeIdentifier;
}
...
declare class BabelNodeBindExpression extends BabelNode {
  type: "BindExpression";
  object: null | BabelNodeExpression;
  callee: BabelNodeExpression;
}
...
declare class BabelNodeTSCallSignatureDeclaration extends BabelNode {
  ...
  typeParameters?: BabelNodeTSTypeParameterDeclaration;
  params: (BabelNodeArrayPattern | BabelNodeIdentifier | BabelNodeObjectPattern | BabelNodeRestElement)[];
  returnType?: BabelNodeTSTypeAnnotation;
}
...
declare class BabelNodeTSTypeReference extends BabelNode {
  ...
  typeArguments?: BabelNodeTSTypeParameterInstantiation;
}
...
declare class BabelNodeTSClassImplements extends BabelNode {
  type: "TSClassImplements";
  expression: BabelNodeExpression;
  typeArguments?: BabelNodeTSTypeParameterInstantiation;
}

declare class BabelNodeTSInterfaceHeritage extends BabelNode {
...
declare class BabelNodeTSModuleDeclaration extends BabelNode {
  ...
  id: BabelNodeTSEntityName | BabelNodeStringLiteral;
  body: BabelNodeTSModuleBlock;
  declare?: boolean;
...
type BabelNodeLVal = BabelNodeIdentifier | BabelNodeMemberExpression | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression;
type BabelNodeTSEntityName = BabelNodeIdentifier | BabelNodeThisExpression | BabelNodeTSQualifiedName;
...
type BabelNodeProperty = BabelNodeObjectProperty | BabelNodeClassProperty | BabelNodeClassPrivateProperty | BabelNodeClassAccessorProperty;
...
type BabelNodeTSType = BabelNodeTSAnyKeyword | BabelNodeTSBooleanKeyword | BabelNodeTSBigIntKeyword | BabelNodeTSIntrinsicKeyword | BabelNodeTSNeverKeyword | BabelNodeTSNullKeyword | BabelNodeTSNumberKeyword | BabelNodeTSObjectKeyword | BabelNodeTSStringKeyword | BabelNodeTSSymbolKeyword | BabelNodeTSUndefinedKeyword | BabelNodeTSUnknownKeyword | BabelNodeTSVoidKeyword | BabelNodeTSThisType | BabelNodeTSFunctionType | BabelNodeTSConstructorType | BabelNodeTSTypeReference | BabelNodeTSTypePredicate | BabelNodeTSTypeQuery | BabelNodeTSTypeLiteral | BabelNodeTSArrayType | BabelNodeTSTupleType | BabelNodeTSOptionalType | BabelNodeTSRestType | BabelNodeTSNamedTupleMember | BabelNodeTSUnionType | BabelNodeTSIntersectionType | BabelNodeTSConditionalType | BabelNodeTSInferType | BabelNodeTSParenthesizedType | BabelNodeTSTypeOperator | BabelNodeTSIndexedAccessType | BabelNodeTSMappedType | BabelNodeTSTemplateLiteralType | BabelNodeTSLiteralType | BabelNodeTSClassImplements | BabelNodeTSInterfaceHeritage | BabelNodeTSImportType;
...
declare module "@babel/types" {
  ...
  declare export function assignmentExpression(operator: "=" | "+=" | "-=" | "/=" | "%=" | "*=" | "**=" | "&=" | "|=" | ">>=" | ">>>=" | "<<=" | "^=" | "||=" | "&&=" | "??=", left: BabelNodeIdentifier | BabelNodeMemberExpression | BabelNodeOptionalMemberExpression | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression, right: BabelNodeExpression): BabelNodeAssignmentExpression;
  ...
  declare export function callExpression(callee: BabelNodeExpression | BabelNodeSuper | BabelNodeImport | BabelNodeV8IntrinsicIdentifier, _arguments: (BabelNodeExpression | BabelNodeSpreadElement | BabelNodeArgumentPlaceholder)[]): BabelNodeCallExpression;
  ...
  declare export function forInStatement(left: BabelNodeVariableDeclaration | BabelNodeIdentifier | BabelNodeMemberExpression | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression, right: BabelNodeExpression, body: BabelNodeStatement): BabelNodeForInStatement;
  ...
  declare export function memberExpression(object: BabelNodeExpression | BabelNodeSuper, property: BabelNodeExpression | BabelNodeIdentifier | BabelNodePrivateName, computed?: boolean): BabelNodeMemberExpression;
  declare export function newExpression(callee: BabelNodeExpression | BabelNodeV8IntrinsicIdentifier, _arguments: (BabelNodeExpression | BabelNodeSpreadElement | BabelNodeArgumentPlaceholder)[]): BabelNodeNewExpression;
  ...
  declare export function objectProperty(key: BabelNodeExpression | BabelNodeIdentifier | BabelNodeStringLiteral | BabelNodeNumericLiteral | BabelNodeBigIntLiteral | BabelNodePrivateName, value: BabelNodeExpression | BabelNodePatternLike, computed?: boolean, shorthand?: boolean): BabelNodeObjectProperty;
  declare export function restElement(argument: BabelNodeIdentifier | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeMemberExpression | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression): BabelNodeRestElement;
  ...
  declare export function updateExpression(operator: "++" | "--", argument: BabelNodeIdentifier | BabelNodeMemberExpression, prefix?: boolean): BabelNodeUpdateExpression;
  ...
  declare export function variableDeclarator(id: BabelNodeIdentifier | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeVoidPattern, init?: BabelNodeExpression): BabelNodeVariableDeclarator;
  ...
  declare export function exportDefaultDeclaration(declaration: BabelNodeFunctionDeclaration | BabelNodeClassDeclaration | BabelNodeExpression | BabelNodeTSDeclareFunction | BabelNodeTSInterfaceDeclaration | BabelNodeEnumDeclaration): BabelNodeExportDefaultDeclaration;
  declare export function exportNamedDeclaration(declaration?: BabelNodeVariableDeclaration | BabelNodeFunctionDeclaration | BabelNodeClassDeclaration | BabelNodeTSDeclareFunction | BabelNodeTSEnumDeclaration | BabelNodeTSImportEqualsDeclaration | BabelNodeTSInterfaceDeclaration | BabelNodeTSModuleDeclaration | BabelNodeTSTypeAliasDeclaration | BabelNodeEnumDeclaration | BabelNodeInterfaceDeclaration | BabelNodeOpaqueType | BabelNodeTypeAlias, specifiers?: (BabelNodeExportSpecifier | BabelNodeExportDefaultSpecifier | BabelNodeExportNamespaceSpecifier)[], source?: BabelNodeStringLiteral, attributes?: BabelNodeImportAttribute[]): BabelNodeExportNamedDeclaration;
  declare export function exportSpecifier(local: BabelNodeIdentifier | BabelNodeStringLiteral, exported: BabelNodeIdentifier | BabelNodeStringLiteral): BabelNodeExportSpecifier;
  declare export function forOfStatement(left: BabelNodeVariableDeclaration | BabelNodeIdentifier | BabelNodeMemberExpression | BabelNodeArrayPattern | BabelNodeObjectPattern | BabelNodeTSAsExpression | BabelNodeTSSatisfiesExpression | BabelNodeTSTypeAssertion | BabelNodeTSNonNullExpression, right: BabelNodeExpression, body: BabelNodeStatement, _await?: boolean): BabelNodeForOfStatement;
  ...
  declare export function templateElement(value: { raw: string, cooked?: string | null }, tail?: boolean): BabelNodeTemplateElement;
  ...
  declare export function bigIntLiteral(value: bigint): BabelNodeBigIntLiteral;
  declare export function exportNamespaceSpecifier(exported: BabelNodeIdentifier | BabelNodeStringLiteral): BabelNodeExportNamespaceSpecifier;
  declare export function optionalMemberExpression(object: BabelNodeExpression, property: BabelNodeExpression | BabelNodePrivateName, computed?: boolean, optional: boolean): BabelNodeOptionalMemberExpression;
  ...
  declare export function declaredPredicate(value: BabelNodeExpression): BabelNodeDeclaredPredicate;
  ...
  declare export function bigIntLiteralTypeAnnotation(value: bigint): BabelNodeBigIntLiteralTypeAnnotation;
  ...
  declare export function objectTypeProperty(key: BabelNodeIdentifier | BabelNodeStringLiteral | BabelNodeNumericLiteral, value: BabelNodeFlowType, variance?: BabelNodeVariance): BabelNodeObjectTypeProperty;
  ...
  declare export function typeofTypeAnnotation(argument: BabelNodeFlowType | BabelNodeIdentifier): BabelNodeTypeofTypeAnnotation;
  ...
  declare export function typeAnnotation(typeAnnotation: BabelNodeFlowType | BabelNodeIdentifier): BabelNodeTypeAnnotation;
  ...
  declare export function typeParameter(name: string, bound?: BabelNodeTypeAnnotation, _default?: BabelNodeFlowType, variance?: BabelNodeVariance): BabelNodeTypeParameter;
  ...
  declare export function enumBooleanMember(id: BabelNodeIdentifier, init: BabelNodeBooleanLiteral): BabelNodeEnumBooleanMember;
  ...
  declare export function jsxElement(openingElement: BabelNodeJSXOpeningElement, closingElement?: BabelNodeJSXClosingElement, children: (BabelNodeJSXText | BabelNodeJSXExpressionContainer | BabelNodeJSXSpreadChild | BabelNodeJSXElement | BabelNodeJSXFragment)[]): BabelNodeJSXElement;
  ...
  declare export function bindExpression(object: null | BabelNodeExpression, callee: BabelNodeExpression): BabelNodeBindExpression;
  declare export function classAccessorProperty(key: BabelNodeIdentifier | BabelNodeStringLiteral | BabelNodeNumericLiteral | BabelNodeBigIntLiteral | BabelNodeExpression | BabelNodePrivateName, value?: BabelNodeExpression, typeAnnotation?: BabelNodeTypeAnnotation | BabelNodeTSTypeAnnotation, decorators?: BabelNodeDecorator[], computed?: boolean, _static?: boolean): BabelNodeClassAccessorProperty;
  ...
  declare export function tsDeclareFunction(id?: BabelNodeIdentifier, typeParameters?: BabelNodeTSTypeParameterDeclaration, params: BabelNodeFunctionParameter[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSDeclareFunction;
  declare export function tsDeclareMethod(key: BabelNodeIdentifier | BabelNodeStringLiteral | BabelNodeNumericLiteral | BabelNodeBigIntLiteral | BabelNodeExpression | BabelNodePrivateName, typeParameters?: BabelNodeTSTypeParameterDeclaration, params: (BabelNodeFunctionParameter | BabelNodeTSParameterProperty)[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSDeclareMethod;
  declare export function tsQualifiedName(left: BabelNodeTSEntityName, right: BabelNodeIdentifier): BabelNodeTSQualifiedName;
  declare export function tsCallSignatureDeclaration(typeParameters?: BabelNodeTSTypeParameterDeclaration, params: (BabelNodeArrayPattern | BabelNodeIdentifier | BabelNodeObjectPattern | BabelNodeRestElement)[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSCallSignatureDeclaration;
  declare export function tsConstructSignatureDeclaration(typeParameters?: BabelNodeTSTypeParameterDeclaration, params: (BabelNodeArrayPattern | BabelNodeIdentifier | BabelNodeObjectPattern | BabelNodeRestElement)[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSConstructSignatureDeclaration;
  ...
  declare export function tsMethodSignature(key: BabelNodeExpression, typeParameters?: BabelNodeTSTypeParameterDeclaration, params: (BabelNodeArrayPattern | BabelNodeIdentifier | BabelNodeObjectPattern | BabelNodeRestElement)[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSMethodSignature;
  ...
  declare export function tsFunctionType(typeParameters?: BabelNodeTSTypeParameterDeclaration, params: (BabelNodeArrayPattern | BabelNodeIdentifier | BabelNodeObjectPattern | BabelNodeRestElement)[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSFunctionType;
  declare export function tsConstructorType(typeParameters?: BabelNodeTSTypeParameterDeclaration, params: (BabelNodeArrayPattern | BabelNodeIdentifier | BabelNodeObjectPattern | BabelNodeRestElement)[], returnType?: BabelNodeTSTypeAnnotation): BabelNodeTSConstructorType;
  declare export function tsTypeReference(typeName: BabelNodeTSEntityName, typeArguments?: BabelNodeTSTypeParameterInstantiation): BabelNodeTSTypeReference;
  ...
  declare export function tsTypeQuery(exprName: BabelNodeTSEntityName | BabelNodeTSImportType, typeArguments?: BabelNodeTSTypeParameterInstantiation): BabelNodeTSTypeQuery;
  ...
  declare export function tsTypeOperator(typeAnnotation: BabelNodeTSType, operator: "keyof" | "readonly" | "unique"): BabelNodeTSTypeOperator;
  ...
  declare export function tsMappedType(key: BabelNodeIdentifier, constraint: BabelNodeTSType, nameType?: BabelNodeTSType, typeAnnotation?: BabelNodeTSType): BabelNodeTSMappedType;
  ...
  declare export function tsClassImplements(expression: BabelNodeExpression, typeArguments?: BabelNodeTSTypeParameterInstantiation): BabelNodeTSClassImplements;
  declare export function tsInterfaceHeritage(expression: BabelNodeExpression, typeArguments?: BabelNodeTSTypeParameterInstantiation): BabelNodeTSInterfaceHeritage;
  declare export function tsInterfaceDeclaration(id: BabelNodeIdentifier, typeParameters?: BabelNodeTSTypeParameterDeclaration, _extends?: BabelNodeTSInterfaceHeritage[], body: BabelNodeTSInterfaceBody): BabelNodeTSInterfaceDeclaration;
  ...
  declare export function tsInstantiationExpression(expression: BabelNodeExpression, typeArguments?: BabelNodeTSTypeParameterInstantiation): BabelNodeTSInstantiationExpression;
  ...
  declare export function tsEnumDeclaration(id: BabelNodeIdentifier, body: BabelNodeTSEnumBody): BabelNodeTSEnumDeclaration;
  ...
  declare export function tsModuleDeclaration(id: BabelNodeTSEntityName | BabelNodeStringLiteral, body: BabelNodeTSModuleBlock): BabelNodeTSModuleDeclaration;
  declare export function tsModuleBlock(body: BabelNodeStatement[]): BabelNodeTSModuleBlock;
  declare export function tsImportType(source: BabelNodeStringLiteral, qualifier?: BabelNodeTSEntityName, typeArguments?: BabelNodeTSTypeParameterInstantiation): BabelNodeTSImportType;
  ...
  declare export function isBigIntLiteralTypeAnnotation(node: ?Object, opts?: ?Object): boolean %checks (node instanceof BabelNodeBigIntLiteralTypeAnnotation)
  declare export function assertBigIntLiteralTypeAnnotation(node: ?Object, opts?: ?Object): void
  ...
  declare export function isTSClassImplements(node: ?Object, opts?: ?Object): boolean %checks (node instanceof BabelNodeTSClassImplements)
  declare export function assertTSClassImplements(node: ?Object, opts?: ?Object): void
  declare export function isTSInterfaceHeritage(node: ?Object, opts?: ?Object): boolean %checks (node instanceof BabelNodeTSInterfaceHeritage)
  declare export function assertTSInterfaceHeritage(node: ?Object, opts?: ?Object): void
