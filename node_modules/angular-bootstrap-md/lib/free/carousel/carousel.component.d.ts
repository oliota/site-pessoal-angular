...
export declare class CarouselComponent implements OnDestroy, AfterViewInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<CarouselComponent, "mdb-carousel", never, { "isControls": "isControls"; "class": "class"; "type": "type"; "animation": "animation"; "allowSwipe": "allowSwipe"; "activeSlide": "activeSlide"; "interval": "interval"; "noWrap": "noWrap"; "noPause": "noPause"; "keyboard": "keyboard"; "activeSlideIndex": "activeSlideIndex"; }, { "activeSlideChange": "activeSlideChange"; }, ["_slidesList"], ["*"]>;
}
