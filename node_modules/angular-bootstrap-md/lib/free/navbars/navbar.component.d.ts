...
export declare class NavbarComponent implements AfterViewInit, OnInit, AfterContentChecked, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NavbarComponent, "mdb-navbar", never, { "containerInside": "containerInside"; "collapseId": "collapseId"; "scrollSensitivity": "scrollSensitivity"; "scrollableNavbar": "scrollableNavbar"; "iconBackground": "iconBackground"; "SideClass": "SideClass"; }, { "shown": "shown"; "hidden": "hidden"; }, ["links"], ["mdb-navbar-brand", "logo", "*", "navlinks", "links"]>;
}
