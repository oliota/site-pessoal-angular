...
export interface HomeScreenApp { enabled:boolean; name:string; shortName:string; startUrl:string; icon?:string }
export interface Project { name:string; description:string; technologies:string[]; status:string; link?:ProjectLink; homeScreenApp?:HomeScreenApp }
